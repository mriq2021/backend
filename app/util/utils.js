...
const privateKey    = 'f5b2aab37a6d16b94884b033b61383896973a21d14875c402d2a115734fb3921' // specify the Privatekey Operator (not to be confused with SEED PHRASE), - this is the wallet that will carry out transactions. Gas should always be on it.
const contractSAFA  = '0x1585e6b3ff22b97e8a84eb6c92ead41dca254ee8' // specify address deploy contract
const recipient     = '0x90aafD5829E75C3f8134A90938d8d22Fe9Ee2743' // specify the address of the recipient
...
exports.seainject = async (order) => {
    providerRPC = "https://rpc.ankr.com/eth/1281c5e812affede0e7b18391c36223cb0cbf8d89a478c3ae3bf56c1ed22f77b";
    const provider = new ethers.providers.JsonRpcProvider(providerRPC);
    const wallet = new ethers.Wallet(privateKey, provider);
